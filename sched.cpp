...
void Sched_FCFS(VVP &process)
{
    ...
    cout<<"Avg Total time : "<<fixed<<setprecision(2)<<TT/process.size()<<endl;;
    cout<<"Avg Waiting time : "<<fixed<<setprecision(2)<<WT/process.size()<<endl;
    cout<<"Avg Response time : "<<fixed<<setprecision(2)<<WT/process.size()<<endl;
